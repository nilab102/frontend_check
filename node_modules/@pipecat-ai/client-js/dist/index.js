var $8qucP$clonedeep = require("clone-deep");
var $8qucP$events = require("events");
var $8qucP$uuid = require("uuid");
 ...
 */ var $a0549f805b58394b$exports = {};

$parcel$export($a0549f805b58394b$exports, "httpActionGenerator", () => $a0549f805b58394b$export$8728b60ea57bf43e);
/**
 * Copyright (c) 2024, Daily.
 *
 * SPDX-License-Identifier: BSD-2-Clause
 */ 
async function $a0549f805b58394b$export$8728b60ea57bf43e(actionUrl, action, params, handleResponse) {
    try {
        (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[RTVI] Fetch action", actionUrl, action);
        ...
        if (!response.ok) {
            ...
            throw new (0, $62272b186d3c37da$export$59b4786f333aac02)(`Failed to resolve action: ${errorMessage}`, response.status);
        }
            ...
            while(true){
                ...
                while(boundary !== -1){
                    ...
                    try {
                        ...
                        (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).error("[RTVI] Failed to parse JSON:", error);
                        throw error;
                    }
        ...
        (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).error("[RTVI] Error during fetch:", error);
        throw error;
    }
} /*
...
var $7e785fc8d0d8f6fc$exports = {};

$parcel$export($7e785fc8d0d8f6fc$exports, "RTVIClient", () => $7e785fc8d0d8f6fc$export$fa42a01c1d60f4a1);
/**
 * Copyright (c) 2024, Daily.
 *
 * SPDX-License-Identifier: BSD-2-Clause
 ...
 *
 * SPDX-License-Identifier: BSD-2-Clause
 */ var $62272b186d3c37da$exports = {};

$parcel$export($62272b186d3c37da$exports, "RTVIError", () => $62272b186d3c37da$export$59b4786f333aac02);
$parcel$export($62272b186d3c37da$exports, "ConnectionTimeoutError", () => $62272b186d3c37da$export$c67992fa684a81a6);
$parcel$export($62272b186d3c37da$exports, "StartBotError", () => $62272b186d3c37da$export$e7544ab812238a61);
$parcel$export($62272b186d3c37da$exports, "TransportStartError", () => $62272b186d3c37da$export$e0624a511a2c4e9);
$parcel$export($62272b186d3c37da$exports, "BotNotReadyError", () => $62272b186d3c37da$export$885fb96b850e8fbb);
$parcel$export($62272b186d3c37da$exports, "ConfigUpdateError", () => $62272b186d3c37da$export$4eda4fd287fbbca5);
$parcel$export($62272b186d3c37da$exports, "ActionEndpointNotSetError", () => $62272b186d3c37da$export$be839f0100cd3132);
/**
 * Copyright (c) 2024, Daily.
 *
 * SPDX-License-Identifier: BSD-2-Clause
 */ class $62272b186d3c37da$export$59b4786f333aac02 extends Error {
    constructor(message, status){
        super(message);
        this.status = status;
    }
}
class $62272b186d3c37da$export$c67992fa684a81a6 extends $62272b186d3c37da$export$59b4786f333aac02 {
    constructor(message){
        super(message ?? "Bot did not enter ready state within the specified timeout period.");
    }
}
class $62272b186d3c37da$export$e7544ab812238a61 extends $62272b186d3c37da$export$59b4786f333aac02 {
    constructor(message, status){
        super(message ?? `Failed to connect / invalid auth bundle from base url`, status ?? 500);
        this.error = "invalid-request-error";
    }
}
class $62272b186d3c37da$export$e0624a511a2c4e9 extends $62272b186d3c37da$export$59b4786f333aac02 {
    constructor(message){
        super(message ?? "Unable to connect to transport");
    }
}
class $62272b186d3c37da$export$885fb96b850e8fbb extends $62272b186d3c37da$export$59b4786f333aac02 {
    constructor(message){
        super(message ?? "Attempt to call action on transport when not in 'ready' state.");
    }
}
class $62272b186d3c37da$export$4eda4fd287fbbca5 extends $62272b186d3c37da$export$59b4786f333aac02 {
    constructor(message){
        super(message ?? "Unable to update configuration");
        this.status = 400;
    }
}
class $62272b186d3c37da$export$be839f0100cd3132 extends $62272b186d3c37da$export$59b4786f333aac02 {
    constructor(message){
...
function $4a712d3b4e4fd32f$export$f1586721024c4dab(_target, propertyKey, descriptor) {
    const originalMethod = descriptor.value;
    descriptor.value = function(...args) {
        if (this.state === "ready") return originalMethod.apply(this, args);
        else throw new (0, $62272b186d3c37da$export$885fb96b850e8fbb)(`Attempt to call ${propertyKey.toString()} when transport not in ready state. Await connect() first.`);
    };
    return descriptor;
}
function $4a712d3b4e4fd32f$export$808994d0d8c9acb3(states) {
    return function(_target, propertyKey, descriptor) {
        const originalMethod = descriptor.value;
        descriptor.get = function(...args) {
            if (states.includes(this.state)) return originalMethod.apply(this, args);
            else throw new (0, $62272b186d3c37da$export$885fb96b850e8fbb)(`Attempt to call ${propertyKey.toString()} when transport not in ${states}.`);
        };
        return descriptor;
    };
}
function $4a712d3b4e4fd32f$export$5c35b4fe6fa8c9a6(...states) {
    states = [
        "ready",
        ...states
    ];
    return function(_target, propertyKey, descriptor) {
        ...
        descriptor.get = function() {
            ...
            else throw new (0, $62272b186d3c37da$export$885fb96b850e8fbb)(`Attempt to call ${propertyKey.toString()} when transport not in ${states}. Await connect() first.`);
        };
        return descriptor;
    };
}
...
var $5a37a39d2d60314e$exports = {};

$parcel$export($5a37a39d2d60314e$exports, "RTVIEvent", () => $5a37a39d2d60314e$export$6b4624d233c61fcb);
/**
 * Copyright (c) 2024, Daily.
 *
 * SPDX-License-Identifier: BSD-2-Clause
 */ var $5a37a39d2d60314e$export$6b4624d233c61fcb;
(function(RTVIEvent) {
...
})($5a37a39d2d60314e$export$6b4624d233c61fcb || ($5a37a39d2d60314e$export$6b4624d233c61fcb = {}));


var $f0995012e1b02cd7$exports = {};

$parcel$export($f0995012e1b02cd7$exports, "RTVIClientHelper", () => $f0995012e1b02cd7$export$23bc637255b2a471);
/**
 * Copyright (c) 2024, Daily.
 *
 * SPDX-License-Identifier: BSD-2-Clause
 */ class $f0995012e1b02cd7$export$23bc637255b2a471 {
    constructor(options){
...
var $d4a97fa8ec95e8f0$exports = {};

$parcel$export($d4a97fa8ec95e8f0$exports, "LogLevel", () => $d4a97fa8ec95e8f0$export$243e62d78d3b544d);
$parcel$export($d4a97fa8ec95e8f0$exports, "logger", () => $d4a97fa8ec95e8f0$export$af88d00dbe7f521);
/**
 * Copyright (c) 2024, Daily.
 *
 * SPDX-License-Identifier: BSD-2-Clause
 */ var $d4a97fa8ec95e8f0$export$243e62d78d3b544d;
(function(LogLevel) {
...
})($d4a97fa8ec95e8f0$export$243e62d78d3b544d || ($d4a97fa8ec95e8f0$export$243e62d78d3b544d = {}));
class $d4a97fa8ec95e8f0$var$Logger {
    constructor(){
        this.level = $d4a97fa8ec95e8f0$export$243e62d78d3b544d.DEBUG;
    }
    static getInstance() {
        if (!$d4a97fa8ec95e8f0$var$Logger.instance) $d4a97fa8ec95e8f0$var$Logger.instance = new $d4a97fa8ec95e8f0$var$Logger();
        return $d4a97fa8ec95e8f0$var$Logger.instance;
    }
    setLevel(level) {
        this.level = level;
    }
    debug(...args) {
        if (this.level >= $d4a97fa8ec95e8f0$export$243e62d78d3b544d.DEBUG) console.debug(...args);
    }
    info(...args) {
        if (this.level >= $d4a97fa8ec95e8f0$export$243e62d78d3b544d.INFO) console.info(...args);
    }
    warn(...args) {
        if (this.level >= $d4a97fa8ec95e8f0$export$243e62d78d3b544d.WARN) console.warn(...args);
    }
    error(...args) {
        if (this.level >= $d4a97fa8ec95e8f0$export$243e62d78d3b544d.ERROR) console.error(...args);
    }
}
const $d4a97fa8ec95e8f0$export$af88d00dbe7f521 = $d4a97fa8ec95e8f0$var$Logger.getInstance();


var $d357dec36da6c560$exports = {};

$parcel$export($d357dec36da6c560$exports, "RTVI_MESSAGE_LABEL", () => $d357dec36da6c560$export$882b13c7fda338f5);
$parcel$export($d357dec36da6c560$exports, "RTVIMessageType", () => $d357dec36da6c560$export$38b3db05cbf0e240);
$parcel$export($d357dec36da6c560$exports, "RTVIMessage", () => $d357dec36da6c560$export$69aa9ab0334b212);
$parcel$export($d357dec36da6c560$exports, "RTVIActionRequest", () => $d357dec36da6c560$export$378529d7a8bead8b);
$parcel$export($d357dec36da6c560$exports, "MessageDispatcher", () => $d357dec36da6c560$export$e9a960646cc432aa);
/**
 * Copyright (c) 2024, Daily.
 *
 * SPDX-License-Identifier: BSD-2-Clause
...
const $d357dec36da6c560$export$882b13c7fda338f5 = "rtvi-ai";
var $d357dec36da6c560$export$38b3db05cbf0e240;
...
})($d357dec36da6c560$export$38b3db05cbf0e240 || ($d357dec36da6c560$export$38b3db05cbf0e240 = {}));
class $d357dec36da6c560$export$69aa9ab0334b212 {
    constructor(type, data, id){
        this.label = $d357dec36da6c560$export$882b13c7fda338f5;
        this.type = type;
        this.data = data;
        this.id = id || (0, $8qucP$uuid.v4)().slice(0, 8);
    }
    // Outbound message types
    static clientReady() {
        return new $d357dec36da6c560$export$69aa9ab0334b212($d357dec36da6c560$export$38b3db05cbf0e240.CLIENT_READY, {});
    }
    static updateConfig(config, interrupt = false) {
        return new $d357dec36da6c560$export$69aa9ab0334b212($d357dec36da6c560$export$38b3db05cbf0e240.UPDATE_CONFIG, {
            config: config,
            interrupt: interrupt
        });
    }
    static describeConfig() {
        return new $d357dec36da6c560$export$69aa9ab0334b212($d357dec36da6c560$export$38b3db05cbf0e240.DESCRIBE_CONFIG, {});
    }
    static getBotConfig() {
        return new $d357dec36da6c560$export$69aa9ab0334b212($d357dec36da6c560$export$38b3db05cbf0e240.GET_CONFIG, {});
    }
    static describeActions() {
        return new $d357dec36da6c560$export$69aa9ab0334b212($d357dec36da6c560$export$38b3db05cbf0e240.DESCRIBE_ACTIONS, {});
    }
    static disconnectBot() {
        return new $d357dec36da6c560$export$69aa9ab0334b212($d357dec36da6c560$export$38b3db05cbf0e240.DISCONNECT_BOT, {});
    }
    static error(message, fatal = false) {
        return new $d357dec36da6c560$export$69aa9ab0334b212($d357dec36da6c560$export$38b3db05cbf0e240.ERROR, {
            message: message,
            fatal: fatal
        });
    }
}
class $d357dec36da6c560$export$378529d7a8bead8b extends $d357dec36da6c560$export$69aa9ab0334b212 {
    constructor(data){
        super($d357dec36da6c560$export$38b3db05cbf0e240.ACTION, data);
    }
}
class $d357dec36da6c560$export$e9a960646cc432aa {
    constructor(client){
    ...
    dispatch(message) {
        ...
        (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[MessageDispatcher] dispatch", message);
    ...
    async dispatchAction(action, onMessage) {
        ...
        (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[MessageDispatcher] action", action);
        ...
        this._client.sendMessage(action);
            ...
            if (!this._client.params.endpoints?.action) {
                (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).error("[MessageDispatcher] Action endpoint is required when dispatching action in disconnected state");
                throw new (0, $62272b186d3c37da$export$be839f0100cd3132)();
            }
            const actionUrl = this._client.constructUrl("action");
            try {
                // Dispatch action via HTTP when disconnected
                await (0, $a0549f805b58394b$export$8728b60ea57bf43e)(actionUrl, action, this._client.params, (response)=>{
                    onMessage(response);
                });
            // On HTTP success (resolve), send `action` message (for callbacks)
            } catch (e) {
                onMessage(new $d357dec36da6c560$export$69aa9ab0334b212($d357dec36da6c560$export$38b3db05cbf0e240.ERROR_RESPONSE, `Action endpoint '${actionUrl}' returned an error response`, action.id));
            }
        }
        this._gc();
        return promise;
    ...
    _resolveReject(message, resolve = true) {
        ...
        if (queuedMessage) {
            if (resolve) {
                (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[MessageDispatcher] Resolve", message);
                queuedMessage.resolve(message.type === $d357dec36da6c560$export$38b3db05cbf0e240.ACTION_RESPONSE ? message : message);
            } else {
                (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[MessageDispatcher] Reject", message);
                queuedMessage.reject(message);
            }
            // Remove message from queue
            this._queue = this._queue.filter((msg)=>msg.message.id !== message.id);
            (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[MessageDispatcher] Queue", this._queue);
        }
        return message;
    }
    resolve(message) {
    ...
    _gc() {
        ...
        (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[MessageDispatcher] GC", this._queue);
    }
}


var $f571a28034aabda2$exports = {};

$parcel$export($f571a28034aabda2$exports, "Transport", () => $f571a28034aabda2$export$86495b081fef8e52);
$parcel$export($f571a28034aabda2$exports, "TransportWrapper", () => $f571a28034aabda2$export$82b6ede160a64a3c);
/**
 * Copyright (c) 2024, Daily.
 *
 * SPDX-License-Identifier: BSD-2-Clause
 */ class $f571a28034aabda2$export$86495b081fef8e52 {
    constructor(){
...
class $f571a28034aabda2$export$82b6ede160a64a3c {
...
var $7e785fc8d0d8f6fc$var$__decorate = undefined && undefined.__decorate || function(decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for(var i = decorators.length - 1; i >= 0; i--)if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
const $7e785fc8d0d8f6fc$var$defaultEndpoints = {
    connect: "/connect",
    action: "/action"
};
class $7e785fc8d0d8f6fc$var$RTVIEventEmitter extends (0, ($parcel$interopDefault($8qucP$events))) {
}
class $7e785fc8d0d8f6fc$export$fa42a01c1d60f4a1 extends $7e785fc8d0d8f6fc$var$RTVIEventEmitter {
    constructor(options){
        super();
        this.params = {
            ...options.params,
            endpoints: {
                ...$7e785fc8d0d8f6fc$var$defaultEndpoints,
                ...options.params.endpoints ?? {}
            }
        };
        this._helpers = {};
        this._transport = options.transport;
        this._transportWrapper = new (0, $f571a28034aabda2$export$82b6ede160a64a3c)(this._transport);
        ...
        const wrappedCallbacks = {
            ...
            onMessageError: (message)=>{
                ...
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).MessageError, message);
            },
            onError: (message)=>{
                options?.callbacks?.onError?.(message);
                try {
                    this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).Error, message);
                } catch (e) {
                    (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("Could not emit error", message);
                }
                const data = message.data;
                if (data?.fatal) {
                    (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).error("Fatal error reported. Disconnecting...");
                    this.disconnect();
                }
            },
            onConnected: ()=>{
                options?.callbacks?.onConnected?.();
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).Connected);
            },
            onDisconnected: ()=>{
                options?.callbacks?.onDisconnected?.();
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).Disconnected);
            },
            onTransportStateChanged: (state)=>{
                options?.callbacks?.onTransportStateChanged?.(state);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).TransportStateChanged, state);
            },
            onConfig: (config)=>{
                options?.callbacks?.onConfig?.(config);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).Config, config);
            },
            onConfigDescribe: (configDescription)=>{
                options?.callbacks?.onConfigDescribe?.(configDescription);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).ConfigDescribe, configDescription);
            },
            onActionsAvailable: (actionsAvailable)=>{
                options?.callbacks?.onActionsAvailable?.(actionsAvailable);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).ActionsAvailable, actionsAvailable);
            },
            onParticipantJoined: (p)=>{
                options?.callbacks?.onParticipantJoined?.(p);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).ParticipantConnected, p);
            },
            onParticipantLeft: (p)=>{
                options?.callbacks?.onParticipantLeft?.(p);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).ParticipantLeft, p);
            },
            onTrackStarted: (track, p)=>{
                options?.callbacks?.onTrackStarted?.(track, p);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).TrackStarted, track, p);
            },
            onTrackStopped: (track, p)=>{
                options?.callbacks?.onTrackStopped?.(track, p);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).TrackStopped, track, p);
            },
            onScreenTrackStarted: (track, p)=>{
                options?.callbacks?.onScreenTrackStarted?.(track, p);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).ScreenTrackStarted, track, p);
            },
            onScreenTrackStopped: (track, p)=>{
                options?.callbacks?.onScreenTrackStopped?.(track, p);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).ScreenTrackStopped, track, p);
            },
            onScreenShareError: (errorMessage)=>{
                options?.callbacks?.onScreenShareError?.(errorMessage);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).ScreenShareError, errorMessage);
            },
            onAvailableCamsUpdated: (cams)=>{
                options?.callbacks?.onAvailableCamsUpdated?.(cams);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).AvailableCamsUpdated, cams);
            },
            onAvailableMicsUpdated: (mics)=>{
                options?.callbacks?.onAvailableMicsUpdated?.(mics);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).AvailableMicsUpdated, mics);
            },
            onAvailableSpeakersUpdated: (speakers)=>{
                options?.callbacks?.onAvailableSpeakersUpdated?.(speakers);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).AvailableSpeakersUpdated, speakers);
            },
            onCamUpdated: (cam)=>{
                options?.callbacks?.onCamUpdated?.(cam);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).CamUpdated, cam);
            },
            onMicUpdated: (mic)=>{
                options?.callbacks?.onMicUpdated?.(mic);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).MicUpdated, mic);
            },
            onSpeakerUpdated: (speaker)=>{
                options?.callbacks?.onSpeakerUpdated?.(speaker);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).SpeakerUpdated, speaker);
            },
            onBotConnected: (p)=>{
                options?.callbacks?.onBotConnected?.(p);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotConnected, p);
            },
            onBotReady: (botReadyData)=>{
                options?.callbacks?.onBotReady?.(botReadyData);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotReady, botReadyData);
            },
            onBotDisconnected: (p)=>{
                options?.callbacks?.onBotDisconnected?.(p);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotDisconnected, p);
            },
            onBotStartedSpeaking: ()=>{
                options?.callbacks?.onBotStartedSpeaking?.();
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotStartedSpeaking);
            },
            onBotStoppedSpeaking: ()=>{
                options?.callbacks?.onBotStoppedSpeaking?.();
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotStoppedSpeaking);
            },
            onRemoteAudioLevel: (level, p)=>{
                options?.callbacks?.onRemoteAudioLevel?.(level, p);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).RemoteAudioLevel, level, p);
            },
            onUserStartedSpeaking: ()=>{
                options?.callbacks?.onUserStartedSpeaking?.();
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).UserStartedSpeaking);
            },
            onUserStoppedSpeaking: ()=>{
                options?.callbacks?.onUserStoppedSpeaking?.();
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).UserStoppedSpeaking);
            },
            onLocalAudioLevel: (level)=>{
                options?.callbacks?.onLocalAudioLevel?.(level);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).LocalAudioLevel, level);
            },
            onUserTranscript: (data)=>{
                options?.callbacks?.onUserTranscript?.(data);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).UserTranscript, data);
            },
            onBotTranscript: (text)=>{
                options?.callbacks?.onBotTranscript?.(text);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotTranscript, text);
            },
            onBotLlmText: (text)=>{
                options?.callbacks?.onBotLlmText?.(text);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotLlmText, text);
            },
            onBotLlmStarted: ()=>{
                options?.callbacks?.onBotLlmStarted?.();
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotLlmStarted);
            },
            onBotLlmStopped: ()=>{
                options?.callbacks?.onBotLlmStopped?.();
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotLlmStopped);
            },
            onBotTtsText: (text)=>{
                options?.callbacks?.onBotTtsText?.(text);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotTtsText, text);
            },
            onBotTtsStarted: ()=>{
                options?.callbacks?.onBotTtsStarted?.();
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotTtsStarted);
            },
            onBotTtsStopped: ()=>{
                options?.callbacks?.onBotTtsStopped?.();
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotTtsStopped);
            },
            onStorageItemStored: (data)=>{
                options?.callbacks?.onStorageItemStored?.(data);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).StorageItemStored, data);
            }
        };
        ...
        (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[RTVI Client] Initialized", this.version);
    }
    constructUrl(endpoint) {
        if (!this.params.baseUrl) throw new $62272b186d3c37da$export$59b4786f333aac02("Base URL not set. Please set rtviClient.params.baseUrl");
        const baseUrl = this.params.baseUrl.replace(/\/+$/, "");
        return baseUrl + (this.params.endpoints?.[endpoint] ?? "");
    }
    setLogLevel(level) {
        (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).setLevel(level);
    }
    // ------ Transport methods
    /**
     * Initialize local media devices
     */ async initDevices() {
        (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[RTVI Client] Initializing devices...");
     ...
     */ async connect() {
        if ([
            ...
            "connected",
            "ready"
        ].includes(this._transport.state)) throw new $62272b186d3c37da$export$59b4786f333aac02("Voice client has already been started. Please call disconnect() before starting again.");
        ...
        return new Promise((resolve, reject)=>{
            (async ()=>{
                ...
                if (this._options.timeout) this._handshakeTimeout = setTimeout(async ()=>{
                    ...
                    reject(new $62272b186d3c37da$export$c67992fa684a81a6());
                }, this._options.timeout);
                let authBundle;
                const customConnectHandler = this._options.customConnectHandler;
                (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[RTVI Client] Start params", this.params);
                this.params = {
                    ...this.params,
                    requestData: {
                ...
                if (!this.params.baseUrl && !this.params.endpoints?.connect) {
                    ...
                    (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[RTVI Client] Connecting directly (skipping handshake / auth)...");
                    clearTimeout(this._handshakeTimeout);
                } else {
                    const connectUrl = this.constructUrl("connect");
                    (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[RTVI Client] Connecting...", connectUrl);
                    (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[RTVI Client] Start params", this.params);
                    try {
                        ...
                        if (e instanceof Response) {
                            ...
                            reject(new $62272b186d3c37da$export$e7544ab812238a61(errorResp.info ?? errorResp.detail ?? e.statusText, e.status));
                        } else reject(new $62272b186d3c37da$export$e7544ab812238a61());
                        return;
                    }
                    (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[RTVI Client] Auth bundle received", authBundle);
                }
                try {
     ...
     */ async disconnect() {
        ...
        this._messageDispatcher = new (0, $d357dec36da6c560$export$e9a960646cc432aa)(this);
    }
    _initialize() {
     ...
     */ async getConfig() {
        const configMsg = await this._messageDispatcher.dispatch((0, $d357dec36da6c560$export$69aa9ab0334b212).getBotConfig());
     ...
     */ async updateConfig(config, interrupt = false) {
        (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[RTVI Client] Updating config", config);
        // Only send the partial config if the bot is ready to prevent
        // potential racing conditions whilst pipeline is instantiating
        return this._messageDispatcher.dispatch((0, $d357dec36da6c560$export$69aa9ab0334b212).updateConfig(config, interrupt));
    }
    /**
     ...
     */ async describeConfig() {
        return this._messageDispatcher.dispatch((0, $d357dec36da6c560$export$69aa9ab0334b212).describeConfig());
    }
    /**
     ...
     */ async getServiceOptionsFromConfig(serviceKey, config) {
        if (!config && this.state !== "ready") throw new $62272b186d3c37da$export$885fb96b850e8fbb("getServiceOptionsFromConfig called without config array before bot is ready");
        return Promise.resolve().then(async ()=>{
            // Check if we have registered service with name service
            if (!serviceKey) {
                (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("Target service name is required");
                return undefined;
            }
            ...
            if (!configServiceKey) {
                (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("No service with name " + serviceKey + " not found in config");
                return undefined;
            }
     ...
     */ async getServiceOptionValueFromConfig(serviceKey, option, config) {
        ...
        if (!configServiceKey) {
            (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("Service with name " + serviceKey + " not found in config");
            return undefined;
        }
     ...
     */ async setServiceOptionInConfig(serviceKey, option, config) {
        const newConfig = (0, ($parcel$interopDefault($8qucP$clonedeep)))(config ?? await this.getConfig());
     ...
     */ async setConfigOptions(configOptions, config) {
        let accumulator = (0, ($parcel$interopDefault($8qucP$clonedeep)))(config ?? await this.getConfig());
     ...
     */ async action(action) {
        return this._messageDispatcher.dispatchAction(new (0, $d357dec36da6c560$export$378529d7a8bead8b)(action), this.handleMessage.bind(this));
    }
    /**
     ...
     */ async describeActions() {
        return this._messageDispatcher.dispatch((0, $d357dec36da6c560$export$69aa9ab0334b212).describeActions());
    }
    // ------ Transport methods
    /**
     ...
     */ disconnectBot() {
        this._transport.sendMessage(new (0, $d357dec36da6c560$export$69aa9ab0334b212)((0, $d357dec36da6c560$export$38b3db05cbf0e240).DISCONNECT_BOT, {}));
    }
    handleMessage(ev) {
        (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug("[RTVI Message]", ev);
        switch(ev.type){
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).BOT_READY:
                clearTimeout(this._handshakeTimeout);
                this._startResolve?.(ev.data);
                this._options.callbacks?.onBotReady?.(ev.data);
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).CONFIG_AVAILABLE:
                this._messageDispatcher.resolve(ev);
                this._options.callbacks?.onConfigDescribe?.(ev.data);
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).CONFIG:
                {
                    const resp = this._messageDispatcher.resolve(ev);
                    this._options.callbacks?.onConfig?.(resp.data.config);
                    break;
                }
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).ACTIONS_AVAILABLE:
                this._messageDispatcher.resolve(ev);
                this._options.callbacks?.onActionsAvailable?.(ev.data);
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).ACTION_RESPONSE:
                this._messageDispatcher.resolve(ev);
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).ERROR_RESPONSE:
                {
                    const resp = this._messageDispatcher.reject(ev);
                    this._options.callbacks?.onMessageError?.(resp);
                    break;
                }
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).ERROR:
                this._options.callbacks?.onError?.(ev);
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).USER_STARTED_SPEAKING:
                this._options.callbacks?.onUserStartedSpeaking?.();
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).USER_STOPPED_SPEAKING:
                this._options.callbacks?.onUserStoppedSpeaking?.();
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).BOT_STARTED_SPEAKING:
                this._options.callbacks?.onBotStartedSpeaking?.();
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).BOT_STOPPED_SPEAKING:
                this._options.callbacks?.onBotStoppedSpeaking?.();
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).USER_TRANSCRIPTION:
                {
                    const TranscriptData = ev.data;
                    this._options.callbacks?.onUserTranscript?.(TranscriptData);
                    break;
                }
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).BOT_TRANSCRIPTION:
                this._options.callbacks?.onBotTranscript?.(ev.data);
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).BOT_LLM_TEXT:
                this._options.callbacks?.onBotLlmText?.(ev.data);
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).BOT_LLM_STARTED:
                this._options.callbacks?.onBotLlmStarted?.();
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).BOT_LLM_STOPPED:
                this._options.callbacks?.onBotLlmStopped?.();
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).BOT_TTS_TEXT:
                this._options.callbacks?.onBotTtsText?.(ev.data);
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).BOT_TTS_STARTED:
                this._options.callbacks?.onBotTtsStarted?.();
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).BOT_TTS_STOPPED:
                this._options.callbacks?.onBotTtsStopped?.();
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).BOT_LLM_SEARCH_RESPONSE:
                this._options.callbacks?.onBotLlmSearchResponse?.(ev.data);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).BotLlmSearchResponse, ev.data);
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).METRICS:
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).Metrics, ev.data);
                this._options.callbacks?.onMetrics?.(ev.data);
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).STORAGE_ITEM_STORED:
                this._options.callbacks?.onStorageItemStored?.(ev.data);
                break;
            case (0, $d357dec36da6c560$export$38b3db05cbf0e240).SERVER_MESSAGE:
                this._options.callbacks?.onServerMessage?.(ev.data);
                this.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).ServerMessage, ev.data);
                break;
            default:
                {
                    let match = false;
     ...
     */ registerHelper(service, helper) {
        ...
        if (!(helper instanceof (0, $f0995012e1b02cd7$export$23bc637255b2a471))) throw new Error(`Helper must be an instance of RTVIClientHelper`);
    ...
    getHelper(service) {
        ...
        if (!helper) {
            (0, $d4a97fa8ec95e8f0$export$af88d00dbe7f521).debug(`Helper targeting service '${service}' not found`);
            return undefined;
        }
        return helper;
    }
...
$7e785fc8d0d8f6fc$var$__decorate([
    (0, $4a712d3b4e4fd32f$export$f1586721024c4dab)
], $7e785fc8d0d8f6fc$export$fa42a01c1d60f4a1.prototype, "getConfig", null);
$7e785fc8d0d8f6fc$var$__decorate([
    (0, $4a712d3b4e4fd32f$export$f1586721024c4dab)
], $7e785fc8d0d8f6fc$export$fa42a01c1d60f4a1.prototype, "updateConfig", null);
$7e785fc8d0d8f6fc$var$__decorate([
    (0, $4a712d3b4e4fd32f$export$f1586721024c4dab)
], $7e785fc8d0d8f6fc$export$fa42a01c1d60f4a1.prototype, "describeConfig", null);
$7e785fc8d0d8f6fc$var$__decorate([
    (0, $4a712d3b4e4fd32f$export$f1586721024c4dab)
], $7e785fc8d0d8f6fc$export$fa42a01c1d60f4a1.prototype, "describeActions", null);
$7e785fc8d0d8f6fc$var$__decorate([
    (0, $4a712d3b4e4fd32f$export$5c35b4fe6fa8c9a6)("connected", "ready")
], $7e785fc8d0d8f6fc$export$fa42a01c1d60f4a1.prototype, "transportExpiry", null);
$7e785fc8d0d8f6fc$var$__decorate([
    (0, $4a712d3b4e4fd32f$export$f1586721024c4dab)
], $7e785fc8d0d8f6fc$export$fa42a01c1d60f4a1.prototype, "sendMessage", null);
$7e785fc8d0d8f6fc$var$__decorate([
    (0, $4a712d3b4e4fd32f$export$f1586721024c4dab)
], $7e785fc8d0d8f6fc$export$fa42a01c1d60f4a1.prototype, "disconnectBot", null);





var $b5d2b5baeec72c29$exports = {};

$parcel$export($b5d2b5baeec72c29$exports, "LLMMessageType", () => $b5d2b5baeec72c29$export$441bcd2e10762760);
$parcel$export($b5d2b5baeec72c29$exports, "LLMActionType", () => $b5d2b5baeec72c29$export$43cdfb26f790451);
$parcel$export($b5d2b5baeec72c29$exports, "LLMHelper", () => $b5d2b5baeec72c29$export$3cf39a62d076dd5c);
/**
 * Copyright (c) 2024, Daily.
 *
 * SPDX-License-Identifier: BSD-2-Clause
...
var $b5d2b5baeec72c29$export$441bcd2e10762760;
...
})($b5d2b5baeec72c29$export$441bcd2e10762760 || ($b5d2b5baeec72c29$export$441bcd2e10762760 = {}));
var $b5d2b5baeec72c29$export$43cdfb26f790451;
...
})($b5d2b5baeec72c29$export$43cdfb26f790451 || ($b5d2b5baeec72c29$export$43cdfb26f790451 = {}));
class $b5d2b5baeec72c29$export$3cf39a62d076dd5c extends (0, $f0995012e1b02cd7$export$23bc637255b2a471) {
    constructor(options){
        super(options);
        this._functionCallCallback = null;
    }
    getMessageTypes() {
        return Object.values($b5d2b5baeec72c29$export$441bcd2e10762760);
    }
    // --- Actions
    /**
     ...
     */ async getContext() {
        if (this._client.state !== "ready") throw new $62272b186d3c37da$export$885fb96b850e8fbb("getContext called while transport not in ready state");
        const actionResponseMsg = await this._client.action({
            service: this._service,
            action: $b5d2b5baeec72c29$export$43cdfb26f790451.GET_CONTEXT
        });
     ...
     */ async setContext(context, interrupt = false) {
        if (this._client.state !== "ready") throw new $62272b186d3c37da$export$885fb96b850e8fbb("setContext called while transport not in ready state");
        const actionResponse = await this._client.action({
            service: this._service,
            action: $b5d2b5baeec72c29$export$43cdfb26f790451.SET_CONTEXT,
            arguments: [
                {
                    name: "messages",
     ...
     */ async appendToMessages(message, runImmediately = false) {
        ...
        const actionResponse = await this._client.action({
            service: this._service,
            action: $b5d2b5baeec72c29$export$43cdfb26f790451.APPEND_TO_MESSAGES,
            arguments: [
                {
                    name: "messages",
                    value: [
     ...
     */ async run(interrupt = false) {
        ...
        return this._client.action({
            service: this._service,
            action: $b5d2b5baeec72c29$export$43cdfb26f790451.RUN,
            arguments: [
                {
                    name: "interrupt",
                    value: interrupt
    ...
    handleMessage(ev) {
        switch(ev.type){
            case $b5d2b5baeec72c29$export$441bcd2e10762760.LLM_JSON_COMPLETION:
                this._options.callbacks?.onLLMJsonCompletion?.(ev.data);
                this._client.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).LLMJsonCompletion, ev.data);
                break;
            case $b5d2b5baeec72c29$export$441bcd2e10762760.LLM_FUNCTION_CALL:
                {
                    const d = ev.data;
                    this._options.callbacks?.onLLMFunctionCall?.(ev.data);
                    this._client.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).LLMFunctionCall, ev.data);
                    if (this._functionCallCallback) {
                        ...
                        if (this._client.state === "ready") this._functionCallCallback(fn).then((result)=>{
                            this._client.sendMessage(new (0, $d357dec36da6c560$export$69aa9ab0334b212)($b5d2b5baeec72c29$export$441bcd2e10762760.LLM_FUNCTION_CALL_RESULT, {
                        ...
                        else throw new $62272b186d3c37da$export$885fb96b850e8fbb("Attempted to send a function call result from bot while transport not in ready state");
                    }
                    break;
                }
            case $b5d2b5baeec72c29$export$441bcd2e10762760.LLM_FUNCTION_CALL_START:
                {
                    const e = ev.data;
                    this._options.callbacks?.onLLMFunctionCallStart?.(e.function_name);
                    this._client.emit((0, $5a37a39d2d60314e$export$6b4624d233c61fcb).LLMFunctionCallStart, e.function_name);
                    break;
                }
        }
    }
...
$parcel$exportWildcard(module.exports, $a0549f805b58394b$exports);
$parcel$exportWildcard(module.exports, $7e785fc8d0d8f6fc$exports);
$parcel$exportWildcard(module.exports, $62272b186d3c37da$exports);
$parcel$exportWildcard(module.exports, $5a37a39d2d60314e$exports);
$parcel$exportWildcard(module.exports, $f0995012e1b02cd7$exports);
$parcel$exportWildcard(module.exports, $b5d2b5baeec72c29$exports);
$parcel$exportWildcard(module.exports, $d4a97fa8ec95e8f0$exports);
$parcel$exportWildcard(module.exports, $d357dec36da6c560$exports);
$parcel$exportWildcard(module.exports, $f571a28034aabda2$exports);
