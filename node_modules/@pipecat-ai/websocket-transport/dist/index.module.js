    ...
    initializeWebsocket(authBundle) {
        ...
        ws.on("message", async (data)=>{
            try {
                ...
                (0, $kR6tG$logger).error("Failed to deserialize incoming message", e);
            }
        });
        ws.on("error", (error)=>{
...
class $5b926fa33e35e45c$export$44a8a077420336af {
    ...
    serializeAudio(data, sampleRate, numChannels) {
        ...
        const muLawSamples = (0, $kR6tG$mulaw).encode(pcmSamples);
    ...
    async deserialize(data) {
        ...
        if (jsonMessage.event === "clear") return {
            ...
            const decoded_audio = (0, $kR6tG$mulaw).decode(serialized_data);
            return {
                type: "audio",
                audio: decoded_audio
            };
...
export {$fc49a56cd8739127$export$45c5b9bfba2f6304 as WavMediaManager, $22ece045290c996a$export$c95c65abc5f47125 as DailyMediaManager, $7f42eda74f1b1632$export$de21836fc42c6f9c as WebSocketTransport, $a6c080dc51c9687f$export$4b2026f8e11b148a as ProtobufFrameSerializer, $5b926fa33e35e45c$export$44a8a077420336af as TwilioSerializer};
